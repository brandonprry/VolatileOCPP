...
messages = [
    ...
    [2,"dddb2599-d678-4ff8-bf38-a230390a1200","StartTransaction",{"connectorId":1,"idTag":"some id","meterStart":42,"timestamp":"2017-10-27T19:10:11Z"}],
   [2,"9b25cbb0-c016-41e7-baa0-e796a9565c11","StatusNotification",{"connectorId":1,"errorCode":"NoError","status":"Available"}],
   ...
   [2, "a187bcd6-4042-4a82-b6d4-b4c55d2f2bee", "GetLocalListVersion", {}],
    [2, "a187bcd6-4042-4a82-b6d4-b4c55d2f2bef", "MeterValues", {"connectorId": 1, "transactionId": 123456, "meterValue": [{"timestamp": "2017-10-27T19:10:11Z", "sampledValue": [{"value": "xxx", "context": "Trigger", "format": "SignedData", "measurand": "Power.Active.Export", "phase": "L1", "location":"Cable", "unit": "kWh"}]}]}],
    [2, "a187bcd6-4042-4a82-b6d4-b4c55d2f2caa", "RemoteStartTransaction", {"connectorId": 1, "idTag": "tagtag"}], #chargingProfile parameter skipped
    [2, "a187bcd6-4042-4a82-b6d4-b4c55d2f2cab", "RemoteStopTransaction", {"transactionId": 123456}],
    [2, "a187bcd6-4042-4a82-b6d4-b4c55d2f2cac", "ReserveNow", {"connectorId": 1, "expiryDate": "2017-10-27T19:10:11Z", "idTag": "tagtag", "reservationId": 89}],
