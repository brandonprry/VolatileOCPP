    ...
    public bool RunScenario(string url, string protocol)
    {
         using (var ws = new WebSocket(url, protocol))
        {
             ...
             ws.OnMessage += (sender, e) =>
            {
                if (i == 1)
                {
                    if (!Utility.ValidateJSON(e.Data, System.IO.File.ReadAllText("/Users/bperry/projects/ocpp/v1.6_schemas/schemas/BootNotificationResponse.json")))
                ...
                {                   
                    if (!Utility.ValidateJSON(e.Data, System.IO.File.ReadAllText("/Users/bperry/projects/ocpp/v1.6_schemas/schemas/HeartbeatResponse.json")))
                        throw new Exception("Invalid response");
                }
            };

            ws.Send("[2,\"852a4cb2-0e20-46f8-bc29-c5ab3cb182c7\",\"BootNotification\",{\"chargePointVendor\":\"Radboud\",\"chargePointModel\":\"Fuzzer\"}]");
Thread.Sleep(1000);
