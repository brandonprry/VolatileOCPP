...
namespace ocpp.maeve.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = ocpp.maeve.Client.Configuration.Default;
            RestClient = new RestClient("http://localhost:9410/api/v0");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://localhost:9410/api/v0).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? ocpp.maeve.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "http://localhost:9410/api/v0")
        {
